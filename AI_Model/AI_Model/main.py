    ...
    for user_data in user_data_iterator:
        ...
        for user_rooms in user_rooms_iterator:
            try:
                ...
                real_user_data = {
                    "room_type": room['name'],
                    "room_size": user_rooms['roomSize'],
                    "surface_type": user_rooms['surfaceType'],
                    "usage_frequency": user_rooms['usageFrequency'],
                    ...
                    "preferred_cleaning_frequency": user_data['preferredCleaningFrequency'],
                ...
                if cleaning_history != None:
                    ...
                    real_user_data["cleaning_quality"]: cleaning_history['cleaningQuality']
